...
import { MANDATORY_FIELDS, getMandatoryFields } from "../constants/mandatoryFields";
...
export const FIELD_ERROR_MESSAGES: Record<string, string> = {
  ...
  "section1_1.allocationToGSDP": "Calculated allocation to GSDP cannot exceed 100%.",
  
  // Section 1.2
  "section1_2.actualCapex": "Actual Capex must be greater than zero.",
  "section1_2.stateCapexUtilisation": "State Capex Utilization must be greater than zero.",
  "section1_2.capexActualsToGSDP": "Calculated capex actuals to GSDP cannot exceed 100%.",
  ...
  "section1_5.ffiArray": "Add at least one financial intermediary when selecting Yes.",
  "section1_5.comment": "Comment (reason) is required.",
  
  // Section 2.1
  "section2_1.infraActArray": "At least one infrastructure act/policy entry is required.",
  "section2_1.infraActArray.sector": "Sector is required.",
  "section2_1.infraActArray.files": "Upload file is required.",
  
  // Section 2.2
  "section2_2.specializedEntityArray": "At least one specialized entity entry is required.",
  ...
  "section2_3.infraDevelopmentArray": "At least one development plan entry is required.",
  ...
  "section2_4.investmentReadyArray.investmentType": "Type of investment is required.",
  "section2_4.investmentReadyArray.projectSize": "Project size is required.",
  "section2_4.comment": "Comment (reason) is required.",
  
  // Section 2.5
  "section2_5.assetMonetizationArray": "At least one asset monetization entry is required.",
  "section2_5.assetMonetizationArray.projectName": "Asset/Project name is required.",
  "section2_5.assetMonetizationArray.type": "Type is required.",
  "section2_5.assetMonetizationArray.sector": "Sector is required.",
  "section2_5.assetMonetizationArray.ownership": "Asset ownership must be ≤100 characters.",
  "section2_5.assetMonetizationArray.estimatedMonetization": "Enter a non-negative amount with up to two decimal places.",
  ...
  "section3_3.VGFArray.type": "Type is required.",
  "section3_3.VGFArray.submissionDate": "Submission date is required (DD-MM-YYYY format).",
  
  // Section 3.4
  "section3_4.projects": "At least one project is required.",
  "section3_4.totalProjectsAwarded": "Total number of infrastructure projects awarded is required.",
  "section3_4.totalProjectCostAwarded": "Total project cost of infrastructure projects awarded is required.",
  "section3_4.projects.totalProjectCost": "Enter a valid non-negative amount with up to two decimal places.",
  "section3_4.projects.capexPercentage": "Enter a valid non-negative percentage.",
