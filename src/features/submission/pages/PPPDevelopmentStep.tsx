...
export const PPPDevelopmentStep = () => {
  ...
  const initialData: PPPDevelopmentData = {
    ...
    section3_3: loadedData.section3_3 || [],
    section3_4: { 
      projects: loadedData.section3_4?.projects || defaultData.section3_4.projects,
    },
  };
  ...
  useEffect(() => {
    ...
    if (currentStepData && Object.keys(currentStepData).length > 0) {
      const syncedData: PPPDevelopmentData = {
        ...
        section3_4: { 
          projects: currentStepData.section3_4?.projects || defaultData.section3_4.projects,
        },
      };
      ...
      try {
        ...
        if (submissionData.formData && submissionData.formData.pppDevelopment) {
          ...
          const updatedData: PPPDevelopmentData = {
            ...
            section3_4: { 
              projects: stepData.section3_4?.projects || defaultData.section3_4.projects,
            },
          };
