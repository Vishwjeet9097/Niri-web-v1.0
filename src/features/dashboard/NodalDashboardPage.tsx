    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="space-y-6 lg:w-[300px] ">
          ...
          <QuickActions
            actions={[
              { id: "1", title: "Data Submission", subtitle: "Start data entry", icon: "file" as const, onClick: () => navigate('/submissions') },
              { id: "2", title: "Copy from Previous", subtitle: "Replicate last submission", icon: "copy" as const, onClick: () => console.log("Copy from previous") },
              { id: "3", title: "View Reports", subtitle: "Performance analytics", icon: "chart" as const, onClick: () => console.log("View reports") },
              { id: "4", title: "Help Center", subtitle: "Guides & documentation", icon: "help" as const, onClick: () => console.log("Help center") },
            ]}
          />
