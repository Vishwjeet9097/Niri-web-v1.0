...
import { getMinistryIndicatorTooltip } from "@/utils/ministryIndicatorTooltips";
import { cn } from "@/lib/utils";

interface MinistryIndicatorTooltipProps {
...
const formatTooltipText = (text: string): React.ReactNode => {
  ...
  const sectionHeaders = [
    ...
    "Scoring Methodology:",
    "Documents Required:",
    "Documents/Website link Required:",
    "Documents/Website Link Required:",
  ];
...
/**
 * Reusable tooltip component for ministry indicators
 * Displays an "i" icon that shows detailed tooltip text on hover
 */
export const MinistryIndicatorTooltip: React.FC<MinistryIndicatorTooltipProps> = ({
  indicatorCode,
  className,
  iconClassName,
}) => {
  const tooltipText = getMinistryIndicatorTooltip(indicatorCode);
